...
export const CLASSIC_STORIES: ClassicStory[] = [
  ...
  // ───────────────────────────────────────────────
  {
    ...
    content: `Érase una vez, en un pueblo rodeado de flores y mariposas de colores, vivía {un/una} {niño/niña} muy especial, {childName}. ✨
...
{childName}, que era muy {listo/lista}, respondió sin miedo:
—Voy a casa de mi abuelita, junto al rosal blanco.

El lobo corrió por el camino corto. Pero {childName} también era muy {listo/lista}. Cuando llegó a la casita y vio que algo no estaba bien, llamó muy fuerte:
...
—¡Mi {childName}! ¡Eres {el/la} {niño/niña} más valiente del mundo!

{childName} se ruborizó de alegría. Tomaron el té con galletas de miel mientras el sol pintaba el cielo de naranja y rosa. 🌅
...
Y desde aquel día, {childName} vivió feliz y libre, sabiendo que era exactamente quien debía ser. ✨`,
...

  {
    ...
    content: `En un reino lejano donde los árboles cantaban y los ríos brillaban como plata, vivía {childName}, {un/una} {niño/niña} de corazón tan puro que las flores se inclinaban a su paso. 🌸
...
Los guardias, sin embargo, tenían buen corazón y dejaron libre a {childName} entre los árboles. Sin saber qué hacer, {childName} corrió hasta que encontró una casita diminuta con siete sillitas y siete camas. 🏡
...
Y desde ese día, {childName} fue {el/la} {hero/heroína} del valle. ✨`,
  },

  {
    ...
    content: `En una casa grande y fría vivía {childName}, {un/una} {niño/niña} trabajador y bondadoso del reino. Sus hermanastras eran malvadas y le hacían limpiar, cocinar y fregar todos los días. Pero {childName} nunca perdía la sonrisa, porque sabía que la bondad siempre tiene recompensa. 🌸

Un día llegó una invitación al palacio: ¡había un gran baile y toda la familia estaba invitada! Las hermanastras se pusieron sus mejores vestidos y se marcharon riendo, dejando a {childName} atrás, con un cubo y una escoba.
...
En el baile, {childName} deslumbró a todos. El príncipe no pudo apartar los ojos de {childName} y bailaron juntos toda la noche. Pero cuando el reloj empezó a sonar las doce... ¡BUM! {childName} salió corriendo, perdiendo un zapatito en las escaleras.
...
{childName} era muy {listo/lista}. Antes de salir, había recogido piedritas blancas y las fue tirando por el camino. Así lograron volver a casa siguiendo el rastro plateado bajo la luz de la luna. 🌙
...
El gato con botas comenzó a cazar liebres y perdices, y se las llevaba al rey como regalo de parte de "{childName}, {el/la} gran {hero/heroína} del reino". El rey quedaba tan impresionado que pronto quiso conocer a ese misterioso personaje.
...
El rey ordenó quemar todas las ruecas del reino. {childName} creció entre amor y aprendió a ser valiente, con mucha curiosidad y amabilidad hacia todos.
...
El invierno llegó frío y duro. {childName} encontró refugio en la madriguera de un topo rico que quería casarse con {childName}, pero que vivía en la oscuridad bajo la tierra.
...
Y cuando los campos volvieron a florecer, la golondrina cumplió su promesa y voló con {childName} hasta un prado lleno de flores gigantes donde vivían pequeñas hadas del mismo tamaño que {childName}.
...
El rey cumplió su promesa: {childName} recibió tierras, riquezas y el título de {hero/heroína} del reino. 👑

—La valentía no está solo en los músculos —dijo {childName} ante todos—, sino en la mente que encuentra siempre la solución. 💡

Y así, {el/la} {niño/niña} más valiente del mundo vivió feliz para siempre. ✨`,
  },
...
Pero entre la multitud estaba {childName}, {un/una} {niño/niña} de ojos claros y corazón honesto.
...
Las olas del mar recibieron a {childName} de vuelta entre aplausos de espuma y luz.
...
{childName} aplaudió con toda su fuerza. Pinocho {lo/la} miró y le dijo:
...
Y {childName} vivió feliz para siempre, sabiendo que el mejor tesoro del mundo es un corazón generoso. ✨`,
...

  {
    ...
    content: `En un reino de dunas doradas y cielos estrellados vivía {childName}, {un/una} {niño/niña} curioso y observador que amaba explorar los alrededores del mercado con su burro. 🏺
...
{childName} sonrió. Con su inteligencia y buen corazón, construyó una vida llena de alegría, amigos y aventuras para siempre. ✨`,
...

  {
    ...
    content: `En el corazón del bosque más verde y tranquilo del mundo, vivía una familia de tres osos: papá oso, mamá osa y {el/la} {pequeño/pequeña} osito. Un día salieron a pasear mientras su porridge se enfriaba. 🐻

Por el camino del bosque venía {childName}, {un/una} {niño/niña} de ojos curiosos como luceros. Al ver la casita de los osos entre los árboles, se asomó a la ventana y, como no había nadie, entró.
...
Y en Hamelín aprendieron para siempre que una promesa rota tiene consecuencias. 🎵`,
...

  {
    ...
    content: `En un palacio rodeado de jardines de flores y fuentes de mármol, vivía {childName}, {un/una} {niño/niña} alegre y juguetón que amaba pasar las tardes junto al pozo del bosque. 🐸
...
Un día, {childName} llegó al castillo tras adentrarse en los bosques nevados. La Bestia, en lugar de asustarla, le ofreció refugio caliente y una habitación preciosa. 🌹
...
—Hola —dijo {childName}—. Soy {childName}. ¿Quieres ser amigos?
...
Juntos comenzaron a planear la escapada. {childName} buscó sábanas y cuerdas que Rapunzel fue trenzando con su largo cabello. 💛
...
{childName} le tomó la mano y corrieron entre los árboles, riendo bajo la luna.
...
{childName} era gran amigo de aquella joven y prometió ayudarla. Esa noche, se escondió en la sala y vio aparecer a un hombrecillo extraño que bailaba en la oscuridad. 🧙
...
{childName} fue {el/la} {hero/heroína} del reino. La joven y su bebé estaban a salvo gracias a su astucia e ingenio. 🌟`,
  },
...
La golondrina, asombrada, escuchó. Y {childName}, que estaba en los escalones estudiando, escuchó también.
...
{childName} lloró al ver a {el/la} {pequeño/pequeña} golondrina. Y también lloró al ver la estatua sin brillo, desnuda de todos sus adornos.
...
Así comenzó la leyenda de {childName}, {el/la} {hero/heroína} que usó su fuerza para proteger, no para dañar. 🌟`,
  },
...
—¡Bien hecho, {childName}! —exclamó—. ¡Campanilla ha encontrado al mejor amigo del mundo!
...
Y desde aquel día, Paddington fue parte de la familia. Con sombrero, mermelada y todo. ❤️✨`,
...

  {
    ...
    content: `En la casa más colorida del pueblo, llamada Villa Madreselva, vivía {el/la} {niño/niña} más extraordinaria que {childName} había conocido jamás: Pippi Calzaslargas. 🧦
...
—Todo esto es tuyo, {childName}. Quiero que {un/una} {niño/niña} con buen corazón sea el dueño de la magia.
...
Porque a veces, la aventura que menos buscas es la que más necesitas. 🌟`,
...

  {
    ...
    content: `En el pueblo de St. Petersburg, junto al Gran Río Misisipi, vivía {childName}, {el/la} {niño/niña} más imaginativo y aventurero de toda la ribera. El río era su reino: ancho, marrón y lleno de secretos. 🚣
...
{childName} era {listo/lista} y muy observador. Mientras se escondía en un barril de manzanas, escuchó los planes secretos de los piratas. Y corrió a avisar a los hombres buenos. 🏴‍☠️
...
{childName} miró el horizonte inmenso de La Mancha y sintió que podría convertirse en {el/la} {hero/heroína} de cualquier historia.
...
El horizonte estaba lleno de nuevos viajes esperando. Y {childName} sabía que estaba listo para todos. 🌅✨`,
...

  {
    ...
    content: `En la antigua Grecia, cuando los dioses aún bajaban a competir con los mortales, {childName} entrenaba cada día al amanecer en las colinas de Arcadia. Corría más rápido que el viento, saltaba más alto que los venados y era {el/la} atleta más veloz de todo el reino. 🏃

Atalanta, la cazadora más legendaria de Grecia, oyó hablar de {childName} y {lo/la} invitó a competir.
...
Los dos corredores salieron como flechas. {childName} sentía el viento en la cara y la tierra bajo los pies. Atalanta corría elegante y poderosa, con la experiencia de mil carreras.

A mitad del recorrido, {childName} se acordó de algo que le había enseñado su entrenador: «No corras contra tu adversario. Corre tu mejor carrera». 💫

En lugar de mirar a Atalanta, {childName} miró la meta. Concentró toda su energía, respiró profundo y dio todo lo que tenía.

Llegaron casi a la vez. La multitud rugió.

Y {childName} cruzó la línea de meta un instante antes.

Atalanta se acercó y {lo/la} abrazó.
—Has ganado. No por ser más rápido. Sino por ser más sabio. Corriste tu carrera, no la mía.
